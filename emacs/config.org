...
Project-short-name | folder/file (or shortened title for notes) \hfill (line:col)
...
#+BEGIN_SRC elisp
  ...
  (defun pi2-6/dashboard-header (title)
    "Insert a fontified header."
    (insert "\n\n" (propertize (format "* %s" title ) 'face 'org-level-2) "\n"))
...
#+BEGIN_SRC elisp
  ...
  (defun pi2-6/dashboard-ongoing ()
    "Creates a list of widget links by pulling all the notes tagged
     ongoingWork."
    (pi2-6/dashboard-header "Ongoing Work")
...
#+BEGIN_SRC elisp
  (defun pi2-6/dashboard-reviews ()
    ...
    (pi2-6/dashboard-header "Reviews")
    ...
    (let ((buf (get-buffer-create "*Dashboard*")))
      (with-current-buffer buf
        (let ((inhibit-read-only t))
          ...
          (pi2-6/dashboard-header "Vulpea/Roam")
