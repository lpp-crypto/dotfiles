...
#+END_SRC
* Sage
[[https://www.sagemath.org/][Sage]] is installed using a conda container, meaning that the container needs to be opened before sage can be run. The following scripts

** Open conda/mamba container

#+BEGIN_SRC shell :tangle ~/dotfiles/scripts/sage-conda-open.zsh
  if [[ $(hostname) == "a-laptop" ]]; then
...
** Scripts starting sage
*** Interactive session
#+BEGIN_SRC zsh :tangle ~/dotfiles/scripts/sage-start.zsh :shebang #!/usr/bin/env zsh
...
#+END_SRC
*** Running a script
#+BEGIN_SRC zsh :tangle ~/dotfiles/scripts/sage-run.zsh :shebang #!/usr/bin/env zsh
  #!/usr/bin/env zsh
