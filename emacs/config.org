...
** Appearance
*** Font
Using [[https://github.com/tonsky/FiraCode/wiki/Emacs-instructions][fira code]] because it looks nice, alonk with [[https://github.com/source-foundry/Hack][Hack]] because Fira code doesn't have italics. Below (see [[*Ligatures]]), we activate the ligatures of =Fira Code=.
#+BEGIN_SRC emacs-lisp
